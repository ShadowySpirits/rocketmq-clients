...
pub(crate) struct SessionManager {
    logger: Logger,
    session_map: Mutex<HashMap<String, Arc<Mutex<Session>>>>,
}
...
mod tests {
    ...
    use hmac::digest::typenum::assert_type;
    use slog::Drain;
